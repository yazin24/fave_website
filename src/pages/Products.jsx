...
const Products = () => {
  return (
    <div className="bg-gradient-to-l from-violet-900 via-violet-400 to-blue-100 px-10 overflow-x-hidden overflow-y-hidden">
      <div className="pt-12">
      ...
      <div
        className="pt-20 flex md:flex-row gap-2 justify-center"
        data-aos="zoom-in"
      ...
      <div className="flex items-center flex-col md:flex-row justify-center md:justify-center gap-16 md:gap-24 mt-10">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-4 md:gap-20">
          <div
            data-aos="fade-right"
            data-aos-easing="ease-out-cubic"
            data-aos-duration="4000"
